...
import xpertss.crypto.x509.CertificateExtensions;
   ...
   static {
      try {
         ...
         VALUE_CLASSES[3] =        // ContentType
            Class.forName("xpertss.crypto.util.ObjectIdentifier");
         VALUE_CLASSES[4] = Class.forName("[B"); // MessageDigest (byte[])
         VALUE_CLASSES[5] = Class.forName("java.util.Date"); // SigningTime
         VALUE_CLASSES[6] = Class.forName("[Lxpertss.crypto.pkcs.SignerInfo;"); // Countersignature
         VALUE_CLASSES[7] = Class.forName("java.lang.String"); // ChallengePassword
         ...
         VALUE_CLASSES[14] = Class.forName("xpertss.crypto.x509.CertificateExtensions"); // ExtensionRequest
