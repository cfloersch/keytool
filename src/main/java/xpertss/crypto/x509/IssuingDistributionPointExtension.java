...
import xpertss.crypto.util.DerInputStream;
...
public class IssuingDistributionPointExtension extends Extension
   ...
   public Enumeration<String> getElements()
   {
      ...
      elements.add(POINT);
      elements.add(REASONS);
      elements.add(ONLY_USER_CERTS);
      elements.add(ONLY_CA_CERTS);
      elements.add(ONLY_ATTRIBUTE_CERTS);
      elements.add(INDIRECT_CRL);
