...
import xpertss.crypto.pkcs.ParsingException;

import sun.security.provider.certpath.X509CertPath;
import sun.security.provider.certpath.X509CertificatePair;

import xpertss.crypto.util.DerValue;
import xpertss.crypto.util.Cache;
 ...
 * @see xpertss.crypto.x509.X509CertImpl
 * @see xpertss.crypto.x509.X509CRLImpl
 */
...
public class X509Factory extends CertificateFactorySpi {
   ...
   private static void checkHeaderFooter(String header, String footer)
      throws IOException
   {
