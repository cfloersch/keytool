...
public class Resources extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        // TODO Add to each sub language file
        {"Exports.certchain",
                "Exports a certificate chain in PKCS7 format"}, //-exportchain
        {"Exports.pemchain",
                "Exports a certificate chain in PEM format"}, //-exportpem
        {"Exports.private",
                "Exports private key"}, //-exportprikey
        ...
        // TODO Add to each sub language file
        {"Private.stored.in.file.filename.",
                "Private key stored in file <{0}>"},
        {"Certchain.stored.in.file.filename.",
                "Certificate chain stored stored in file <{0}>"},
        ...
        // TODO Replicate to other languages
        {"Alias.alias.has.no.certchain",
                "Alias <{0}> has no certificate chain"},
        ...
        {"Public.key.fingerprint.SHA1.", "Public Key fingerprint (SHA1): "},
